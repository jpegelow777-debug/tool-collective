  // YOUR BRAND COLORS — locked in forever
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-8 mb-20">
            ...
            >
              ...
              <select
                ...
                className="w-full px-6 py-5 rounded-2xl bg-white border-2 border-gray-200 text-gray-900 text-lg font-medium
                           focus:outline-none focus:border-transparent focus:ring-4 
                           focus:ring-orange-200 transition-all duration-300 
                           appearance-none cursor-pointer shadow-lg hover:shadow-xl"
                style={{
          ...
          <div className="md:col-span-2 text-center mt-12">
            <button
              type="submit"
              disabled={loading}
              className="relative px-24 py-7 text-2xl font-bold text-white rounded-2xl shadow-2xl transition-all duration-300
                         hover:scale-105 hover:shadow-3xl overflow-hidden"
              style={{
